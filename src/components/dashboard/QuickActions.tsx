...
import { TaskItem, NoteItem, VineyardBlock } from '@/types';
...
export const QuickActions: React.FC<QuickActionsProps> = ({ blocks, onAddTask, onAddNote }) => {
    ...
    <div className="flex flex-wrap gap-2">
      ...
      <Dialog>
        ...
        <DialogContent>
          ...
          {/* Phase recording form would go here */}
          <DialogFooter>
            <Button variant="outline">Cancel</Button>
            <Button>Record Phase</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
